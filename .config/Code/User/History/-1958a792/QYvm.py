...
class FairyGodmotherQuest:
    def __init__(self, master):
        ...
        self.story_parts = [
            ...
            Finally, as she wandered through the world, she found many creatures in need of help. Even as others gave up on trying to assist them, or went about it in a way that made the creatures uncomfortable, the fairy reached deep inside of herself to find true empathy, the base for her magic. As she encountered these creatures, she kindly offered a helping hand, without hurting their feelings. She learned that she could grow her magic and change other's days for the better with small acts of kindness. No matter how little, every good deed made a difference, especially to those overlooked creatures.  
            """,
            """
